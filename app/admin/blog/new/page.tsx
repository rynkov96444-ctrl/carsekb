...
export default function AdminBlogNewPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold">Написать статью</h1>
        <p className="text-muted-foreground mt-2">Создайте новую публикацию для блога</p>
      </div>
      ...
      <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {coverImage ? (
                ...
                <label className="aspect-video rounded-lg border-2 border-dashed flex flex-col items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors">
                  ...
                  <span className="text-xs text-muted-foreground mt-1">Рекомендуемый размер: 1200x630px</span>
                  <input
                    type="file"
                    accept="image/*"
                    className="hidden"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Напишите текст статьи</CardDescription>
          </CardHeader>
          <CardContent>
            <textarea 
